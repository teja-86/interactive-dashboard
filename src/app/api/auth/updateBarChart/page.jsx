...
function page() {
  ...
  <div>
    <label htmlFor="paid" class="block text-sm font-medium text-gray-700">High</label>
    <input
      type="text"
      id="high"
      name="high"
  ...
  <div>
    <label htmlFor="organic" class="block text-sm font-medium text-gray-700">Low</label>
    <input
      type="text"
      id="low"
      name="low"
